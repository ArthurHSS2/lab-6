...
//   I-type  (0010011): addi, andi, ori, xori, slli, srli, srai
//   I-type  (0000011): lw
//   S-type  (0100011): sw
//   B-type  (1100011): beq
//
...
//
//   Signal    | R-type | I-type | lw | sw | beq
//   ----------|--------|--------|----|----|-----
//   ALUSrc    |   0    |   1    |  1 |  1 |  0
//   MemtoReg  |   0    |   0    |  1 |  - |  -
//   RegWrite  |   1    |   1    |  1 |  0 |  0
...
//     2'b10 = R-type or I-type arithmetic (ALU Control decodes Funct3/Funct7)
// =============================================================================
...
module sc_control (
    ...
    localparam I_TYPE = 7'b0010011; // addi, andi, ori, xori, slli, srli, srai
    ...
    always_comb begin
        ...
        case (Opcode)
            ...
            I_TYPE: begin
                ...
                MemWrite = 1'b0;
                Branch   = 1'b0;
                ALUOp    = 2'b10; // ALU control decodes Funct3
            end
